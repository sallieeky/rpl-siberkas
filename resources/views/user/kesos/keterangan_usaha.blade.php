            ...
            <div class="card-body">
                ...
                <form action="/kesos/keterangan-usaha" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama" disabled value="{{ $ku->nama }}">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                            <label for="nama">NIK</label><span class="text-danger">*</span>
                            <input type="text" class="form-control" id="nik" name="nik" placeholder="NIK" disabled value="{{ $ku->nik }}">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                            <label for="ttl">Tempat Tanggal Lahir</label><span class="text-danger">*</span>
                            <input type="text" class="form-control" id="ttl" name="ttl" placeholder="Tempat Tanggal Lahir" disabled value="{{ $ku->ttl }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat" disabled value="{{ $ku->alamat }}">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                            <label for="no_telp">Nomor Telepon/Hp</label><span class="text-danger">*</span>
                            <input type="text" class="form-control" id="no_telp" name="no_telp" placeholder="Nomor Telepon/Hp" disabled value="{{ $ku->no_telp }}">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="jenis_kelamin" name="jenis_kelamin" disabled>
                              <option value="{{ $ku->jenis_kelamin }}">{{ $ku->jenis_kelamin }}</option>
                            </select>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="status_perkawinan" name="status_perkawinan" disabled>
                              <option value="{{ $ku->status_perkawinan }}">{{ $ku->status_perkawinan }}</option>
                            </select>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="agama" name="agama" disabled>
                              <option value="{{ $ku->agama }}">{{ $ku->agama }}</option>
                            </select>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="pekerjaan" name="pekerjaan" placeholder="Pekerjaan" disabled value="{{ $ku->pekerjaan }}">
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="bidang_usaha" name="bidang_usaha" placeholder="Bidang Usaha" disabled value="{{ $ku->bidang_usaha }}">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                            <label for="alamat_tempat_usaha">Alamat Tempat Usaha</label><span class="text-danger">*</span>
                            <input type="text" class="form-control" id="alamat_tempat_usaha" name="alamat_tempat_usaha" placeholder="Alamat Tempat Usaha" disabled value="{{ $ku->alamat_tempat_usaha }}">
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="mulai_usaha" name="mulai_usaha" placeholder="Mulai Usaha" disabled value="{{ $ku->mulai_usaha }}">
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                            <a href="{{ asset('storage/kesos/surat_pengantar/'.$ku->surat_pengantar) }}" target="_blank" class="btn btn-link">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                            <a href="{{ asset('storage/kesos/ktp/'.$ku->ktp) }}" target="_blank" class="btn btn-link">
                              <i class="fas fa-file-pdf"></i>
                              KTP
                            </a>
                        </div>
