            ...
            <div class="card-body">
                ...
                <form action="/tapem/formulir-keterangan-kurang-mampu" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama" disabled value="{{ $fkkm->nama }}">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                            <label for="nama">NIK</label><span class="text-danger">*</span>
                            <input type="text" class="form-control" id="nik" name="nik" placeholder="NIK" disabled value="{{ $fkkm->nik }}">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                            <label for="ttl">Tempat Tanggal Lahir</label><span class="text-danger">*</span>
                            <input type="text" class="form-control" id="ttl" name="ttl" placeholder="Contoh: Balikpapan, 1 Januari 1995" disabled value="{{ $fkkm->ttl }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat" disabled value="{{ $fkkm->alamat }}">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                            <label for="no_telp">Nomor Telepon/Hp</label><span class="text-danger">*</span>
                            <input type="text" class="form-control" id="no_telp" name="no_telp" placeholder="Nomor Telepon/Hp" disabled value="{{ $fkkm->no_telp }}">
                        </div>
                      </div>
                    </div>
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama_ortu" name="nama_ortu" placeholder="Nama Orang Tua" disabled value="{{ $fkkm->nama_ortu }}">
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group">
                                    <label for="ttl_ortu">Tempat Tanggal Lahir Orang Tua</label><span class="text-danger">*</span>
                                    <input type="text" class="form-control" id="ttl_ortu" name="ttl_ortu" placeholder="Contoh: Balikpapan, 1 Januari 1995" disabled value="{{ $fkkm->ttl_ortu }}">
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group">
                                    <label for="jenis_kelamin_ortu">Jenis Kelamin Orang Tua</label><span class="text-danger">*</span>
                                    <select class="form-control" id="jenis_kelamin_ortu" name="jenis_kelamin_ortu" disabled>
                                      <option value="{{ $fkkm->jenis_kelamin_ortu }}">{{ $fkkm->jenis_kelamin_ortu }}</option>
                                    </select>
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="agama_ortu" name="agama_ortu" disabled>
                                      <option value="{{ $fkkm->agama_ortu }}">{{ $fkkm->agama_ortu }}</option>
                                    </select>
                                </div>
                              </div>
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="pekerjaan_ortu" name="pekerjaan_ortu" placeholder="Pekerjaan Orang Tua" disabled value="{{ $fkkm->pekerjaan_ortu }}">
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group">
                                    <label for="alamat_ortu">Alamat Orang Tua</label><span class="text-danger">*</span>
                                    <input type="text" class="form-control" id="alamat_ortu" name="alamat_ortu" placeholder="Alamat Orang Tua" disabled value="{{ $fkkm->alamat_ortu }}">
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="nama_anak" name="nama_anak" placeholder="Nama Anak" disabled value="{{ $fkkm->nama_anak }}">
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                  <label for="jenis_kelamin_anak">Jenis Kelamin Anak</label><span class="text-danger">*</span>
                                  <select class="form-control" id="jenis_kelamin_anak" name="jenis_kelamin_anak" disabled>
                                    <option value="{{ $fkkm->jenis_kelamin_anak }}">{{ $fkkm->jenis_kelamin_anak }}</option>
                                  </select>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="ttl_anak" name="ttl_anak" placeholder="Contoh: Balikpapan, 1 Januari 1995" disabled value="{{ $fkkm->ttl_anak }}">
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                  <label for="sekolah_anak">Sekolah Anak</label><span class="text-danger">*</span>
                                  <input type="text" class="form-control" id="sekolah_anak" name="sekolah_anak" placeholder="Sekolah Anak" disabled value="{{ $fkkm->sekolah_anak }}">
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                            <a href="{{ asset('storage/tapem/surat_pengantar/'.$fkkm->surat_pengantar) }}" target="_blank" class="btn btn-link">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                            <a href="{{ asset('storage/tapem/ktp/'.$fkkm->ktp) }}" target="_blank" class="btn btn-link">
                              <i class="fas fa-file-pdf"></i>
                              KTP
                            </a>
                        </div>
