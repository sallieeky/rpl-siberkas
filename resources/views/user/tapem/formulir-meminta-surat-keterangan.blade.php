            ...
            <div class="card-body">
                ...
                <form action="/tapem/formulir-meminta-surat-keterangan" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama" disabled value="{{ $fmsk->nama }}">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                            <label for="nama">NIK</label><span class="text-danger">*</span>
                            <input type="text" class="form-control" id="nik" name="nik" placeholder="NIK" disabled value="{{ $fmsk->nik }}">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                            <label for="ttl">Tempat Tanggal Lahir</label><span class="text-danger">*</span>
                            <input type="text" class="form-control" id="ttl" name="ttl" placeholder="Tempat Tanggal Lahir" disabled value="{{ $fmsk->ttl }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="alamat" name="alamat" rows="3" placeholder="Alamat" disabled>{{ $fmsk->alamat }}</textarea>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                            <label for="no_telp">Nomor Telepon/Hp</label><span class="text-danger">*</span>
                            <input type="text" class="form-control" id="no_telp" name="no_telp" placeholder="Nomor Telepon/Hp" disabled value="{{ $fmsk->no_telp }}">
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="jenis_kelamin" name="jenis_kelamin" disabled>
                              <option value="{{ $fmsk->jenis_kelamin }}">{{ $fmsk->jenis_kelamin }}</option>
                            </select>
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="agama" name="agama" disabled>
                              <option value="{{ $fmsk->agama }}">{{ $fmsk->agama }}</option>
                            </select>
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="pekerjaan" name="pekerjaan" placeholder="Pekerjaan" disabled value="{{ $fmsk->pekerjaan }}">
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="status_perkawinan" name="status_perkawinan" disabled>
                              <option value="{{ $fmsk->status_perkawinan }}">{{ $fmsk->status_perkawinan }}</option>
                            </select>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="keperluan" name="keperluan" rows="3" placeholder="Keperluan" disabled>{{ $fmsk->keperluan }}</textarea>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                            <a href="{{ asset('storage/tapem/surat_pengantar/'.$fmsk->surat_pengantar) }}" target="_blank" class="btn btn-link">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                            <a href="{{ asset('storage/tapem/ktp/'.$fmsk->ktp) }}" target="_blank" class="btn btn-link">
                              <i class="fas fa-file-pdf"></i>
                              KTP
                            </a>
                        </div>
