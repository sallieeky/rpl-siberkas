            ...
            <div class="card-body">
                ...
                <form action="/ppsda/keterangan-njop" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama" disabled value="{{ $njop->nama }}">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                            <label for="nama">NIK</label><span class="text-danger">*</span>
                            <input type="text" class="form-control" id="nik" name="nik" placeholder="NIK" disabled value="{{ $njop->nik }}">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                            <label for="ttl">Tempat Tanggal Lahir</label><span class="text-danger">*</span>
                            <input type="text" class="form-control" id="ttl" name="ttl" placeholder="Tempat Tanggal Lahir" disabled value="{{ $njop->ttl }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat" disabled value="{{ $njop->alamat }}">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                            <label for="no_telp">Nomor Telepon/Hp</label><span class="text-danger">*</span>
                            <input type="text" class="form-control" id="no_telp" name="no_telp" placeholder="Nomor Telepon/Hp" disabled value="{{ $njop->no_telp }}">
                        </div>
                      </div>
                    </div>
                          ...
                          <div class="row">
                            <div class="col-md-4">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="no_objek_pajak" name="no_objek_pajak" placeholder="Nomor Objek Pajak" disabled value="{{ $njop->no_objek_pajak }}">
                              </div>
                            </div>
                            <div class="col-md-4">
                              <div class="form-group">
                                  <label for="jenis_objek_pajak">Jenis Objek Pajak</label><span class="text-danger">*</span>
                                  <input type="text" class="form-control" id="jenis_objek_pajak" name="jenis_objek_pajak" placeholder="Jenis Objek Pajak" disabled value="{{ $njop->jenis_objek_pajak }}">
                              </div>
                            </div>
                            <div class="col-md-4">
                              <div class="form-group">
                                  <label for="letak_objek">Letak Objek Pajak</label><span class="text-danger">*</span>
                                  <input type="text" class="form-control" id="letak_objek" name="letak_objek" placeholder="Letak Objek Pajak" disabled value="{{ $njop->letak_objek }}">
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="bumi_luas" name="bumi_luas" placeholder="Luas Bumi" disabled value="{{ $njop->bumi_luas }}">
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                  <label for="bumi_njop">NJOP Bumi</label><span class="text-danger">*</span>
                                  <input type="text" class="form-control" id="bumi_njop" name="bumi_njop" placeholder="NJOP Bumi" disabled value="{{ $njop->bumi_njop }}">
                              </div>
                            </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="bangunan_luas" name="bangunan_luas" placeholder="Luas Bangunan" disabled value="{{ $njop->bangunan_luas }}">
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                  <label for="bangunan_njop">NJOP Bangunan</label><span class="text-danger">*</span>
                                  <input type="text" class="form-control" id="bangunan_njop" name="bangunan_njop" placeholder="NJOP Bangunan" disabled value="{{ $njop->bangunan_njop }}">
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                            <a href="{{ asset('storage/ppsda/surat_pengantar/'.$njop->surat_pengantar) }}" target="_blank" class="btn btn-link">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                            <a href="{{ asset('storage/ppsda/ktp/'.$njop->ktp) }}" target="_blank" class="btn btn-link">
                              <i class="fas fa-file-pdf"></i>
                              KTP
                            </a>
                        </div>
